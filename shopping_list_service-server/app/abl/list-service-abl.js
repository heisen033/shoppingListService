...
const Errors = require("../api/errors/list-service-error.js");
...
const logger = LoggerFactory.get("ListServiceAbl");

class ListServiceAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "ShoppingList",
        typeCode: "shopping-list-service",
        location: location,
...
module.exports = new ListServiceAbl();
